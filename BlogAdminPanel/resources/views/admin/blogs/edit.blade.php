     ...
     <div class="card">
          ...
          <div class="card-body">
               ...
               <form action="{{ route('blogs.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                         <div class="row mb-3">
                              <label class="col-form-label col-lg-2">Bloq başlığı</label>
                              <div class="col-lg-10">
                                   <div class="form-floating">
                                        <input type="text" class="form-control" placeholder="Placeholder" name="title" value="{{ $blog->title }}" />
                         ...
                         <div class="row mb-3">
                              <label class="col-form-label col-lg-2">Açıqlama</label>
                              <div class="col-lg-10">
                                   <div class="form-floating">
                                        <textarea class="form-control" id="editor" style="height: 100px;" name="content">{!! $blog->content !!}</textarea>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="row mb-3">
                              <label class="col-form-label col-lg-2">Taq</label>
                                   <div class="col-lg-10">
                                        <div class="input-group">
                                             <select name="tags[]" class="tags-selector" multiple>
