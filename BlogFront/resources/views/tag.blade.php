    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <h1 class="section-title h2 mb-3">
          <span>{{ $blogs[0]->tags[0]['name'] }}</span>
        </h1>
        <ul class="list-inline breadcrumb-menu mb-3">
          <li class="list-inline-item"><a href="{{ route('home') }}"><i class="ti ti-home"></i>  <span>Ana Səhifə</span></a></li>
          <li class="list-inline-item">• &nbsp; <a href="{{ route('tags') }}"><span>Taglar</span></a></li>
          <li class="list-inline-item">• &nbsp; <span>{{ $blogs[0]->tags[0]['name'] }}</span></li>
        </ul>
      </div>
    </div>
  </div>
